...
var FetchReputationRpcResult = struct$1({
  jsonrpc: struct$1.literal('2.0'),
  id: 'string',
  error: 'any?',
  result: 'number?'
...
function () {
  ...
  _createClass(Connection, [{
    ...
    value: function () {
      ...
      /*#__PURE__*/
      _regeneratorRuntime.mark(function _callee5(signature) {
        var unsafeRes, res;
    ...
    value: function () {
      ...
      /*#__PURE__*/
      _regeneratorRuntime.mark(function _callee9(signature) {
        var unsafeRes, res;
    ...
    value: function () {
      ...
      /*#__PURE__*/
      _regeneratorRuntime.mark(function _callee13(to, amount) {
        var unsafeRes, res;
    ...
    */
    ...
    value: function () {
      ...
      /*#__PURE__*/
      _regeneratorRuntime.mark(function _callee15(transaction) {
        var _len,
            signers,
            _key,
            seconds,
    ...
    value: function () {
      ...
      /*#__PURE__*/
      _regeneratorRuntime.mark(function _callee17(rawTransaction) {
        var unsafeRes, res;
...
function () {
  ...
  _createClass(SystemController, null, [{
    ...
    value: function createNewAccount(from, _createNewAccount, difs, reputations, space, controllerId) {
      var dataLayout = struct([u32('instruction'), ns64('difs'), ns64('reputations'), ns64('space'), pubKey('controllerId')]);
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 8:
                ...
                transactions.push(sendAndconfmTx(connection, _transaction, payer, controller)); // Delay ~1 tick between write transactions in an attempt to reduce AccountInUse errors
              ...
              case 26:
                ...
                _context.next = 32;
                return sendAndconfmTx(connection, _transaction2, payer, controller);
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                transaction = SystemController.createNewAccount(owner.pubKey, tokenAccount.pubKey, 1, 0, 1 + TokenAccountDetailLayout.span, this.controllerId);
                _context.next = 8;
          ...
          while (1) {
            switch (_context8.prev = _context8.next) {
              ...
              case 5:
                ...
                transaction = SystemController.createNewAccount(owner.pubKey, tokenAccount.pubKey, 1, 0, 1 + data.length, controllerId);
                _context8.next = 13;
